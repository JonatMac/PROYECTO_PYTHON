...
class TestInstitutionController(BaseTestCase):
    ...
    def test_add_institution(self):
        ...
        response = self.client.open('/rest/globalhitss-api/v1.0/institution',method='POST',data=json.dumps(body),content_type='application/json')
    ...
    def test_delete_institution(self):
        ...
        """
        response = self.client.open('/rest/globalhitss-api/v1.0/institution/{institutionId}'.format(institution_id=789),method='DELETE')
        self.assert200(response,'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_get_institution(self):
        ...
        Lista instituciones
        """
        response = self.client.open('/rest/globalhitss-api/v1.0/institution',method='GET')
        self.assert200(response,'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_get_institution_by_id(self):
        ...
        """
        response = self.client.open('/rest/globalhitss-api/v1.0/institution/{institutionId}'.format(institution_id=789),method='GET')
        self.assert200(response,'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_update_institution(self):
        ...
        response = self.client.open('/rest/globalhitss-api/v1.0/institution',method='PUT',data=json.dumps(body),content_type='application/json')
        self.assert200(response,'Response body is : ' + response.data.decode('utf-8'))
